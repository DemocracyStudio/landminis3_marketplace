...
// token minting helpers prevent hard-coding contract names with constant
const contractName = 'marketplace0';
...
// order tuple helper for the net-asset 
interface Order {
    taker?: string,
    tokenId: number,
    expiry: number,
...
// helper to create a whitelisting transaction is a one-liner
...
// helpers to construct listing an NFT for sale and SIP010 fungible tokens
Clarinet.test({
